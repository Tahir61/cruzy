  ...
  if (komut == "aç") {
    ...
    if (kasa == "L1-KASA") {
      if (!para) {
        ...
        client.channels.cache.get("838391089588731934").send(`:dollar:  ${message.member} **L1-KASA**'yı satın aldı!`)
      ...
      if (!para) {
        ...
        client.channels.cache.get("838391089588731934").send(`:dollar:  ${message.member} **L2-KASA**'yı satın aldı!`)
      ...
      if (!para) {
        const embed = new Discord.MessageEmbed()
          ...
          .setFooter(`Kasalarınıza bakmak için; !kasalarınıza bakmak için; !kasalarım`);
        message.channel.send(embed);
        return;
      } else if (para < 250) {
        const embed = new Discord.MessageEmbed()
        ...
        client.channels.cache.get("838391089588731934").send(`:dollar:  ${message.member} **L3-KASA**'yı satın aldı!`)
      }
    } else {
      const embed = new Discord.MessageEmbed()
        .setColor("RED")
